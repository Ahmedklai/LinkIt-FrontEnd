...
const LinkShortnerForm: React.FC<{
  initialUrl: string;
  createNewUrl: (url: CreateNewUrlPayload) => Promise<{ success: boolean }>;
  showPreview?: boolean;
}> = ({ initialUrl, createNewUrl, showPreview = true }) => {
      ...
      >
        ...
        <div className="form-group">
          ...
          <input
            ...
            className="w-full px-4 py-2 rounded-full border border-gray-300 my-1 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
          />
          {errors.originalUrl && (
        ...
        <div className="form-group">
          ...
          >
            ...
            <div className="flex items-center space-x-1">
              <span className="bg-gray-100 dark:bg-gray-700 px-3 py-2 rounded-l-full">
                mvst.co/
              </span>
              <input
                id="workspace-slug"
                ...
                className="w-full px-3 py-2  rounded-r-full my-1 outline-none bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder:text-gray-600 dark:placeholder:text-gray-300"
              />
            </div>
          </div>
        </div>
              ...
              {geoTargetingEntries.map((entry, index) => (
                <div key={index} className="flex items-center gap-4 mb-2">
                  ...
                  <select
                    value={entry.country}
                    onChange={(e) =>
                      updateGeoTargetingEntry(index, "country", e.target.value)
                    }
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            className="w-full px-4 py-2 rounded-xl border border-gray-300 my-1 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
          />
        </div>
